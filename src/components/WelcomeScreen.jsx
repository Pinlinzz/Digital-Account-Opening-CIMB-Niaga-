  ...
  return (
    <div className="section-container py-12 space-y-20">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-8 lg:p-12 shadow-sm">
        ...
        <div className="flex items-start justify-center gap-6 max-w-6xl mx-auto overflow-x-auto pb-4">
          {/* Step 1 */}
          <div className="flex items-center gap-4 min-w-fit px-3">
            <div className="w-20 h-20 bg-[#E0413D] rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <Button
              ...
              size="lg"
              className="bg-[#E0413D] hover:bg-[#C73632] text-white h-12 px-8 shadow-sm text-base font-semibold"
            >
